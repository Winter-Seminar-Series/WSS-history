    ...
    <footer className="border-t border-neutral-200 bg-white pb-7 pt-14 text-gray-700">
      <div className="mx-auto max-w-[1200px] px-6">
        <div className="flex items-center justify-between gap-y-4 max-md:flex-col">
          ...
          <a href="https://www.sahab.ir/" target="_blank">
            <Image
              src="/source/sponsors/sahab.png"
              alt="tosan"
              height="120"
              width="95"
              className="opacity-60 scale-125 grayscale hover:opacity-100 hover:grayscale-0"
            />
          </a>
          <a href="https://pushe.co/" target="_blank">
            <Image
              src="/source/sponsors/pooshe.svg"
              alt="tosan"
              height="120"
              width="95"
              className="opacity-60 scale-125 grayscale hover:opacity-100 hover:grayscale-0"
