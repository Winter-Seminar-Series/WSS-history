  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      <button
        ...
        className={`flex items-center rounded-md px-6 text-base font-normal max-lg:h-9 max-lg:px-4 lg:h-12 ${
          transparent
          ...
          <ul className="py-2">
            {historyData.map((value, index) => {
              return (
                <li
                  key={value.url}
                  className="animate-slideIn group flex transform cursor-pointer items-center px-4 py-2 text-sm text-gray-700 opacity-0"
                  style={{
